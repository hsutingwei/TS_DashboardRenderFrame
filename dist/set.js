 ...
 */
    ...
    */
     ...
     */
    SetDatePick(tPageName, tFieldName) {
        /**預設值 */
        let DateObj = {
            weekStart: 1,
            todayBtn: true,
    ...
    */
    ...
    ResetSearchDisplayFromURL(DefaultObj, UrlObj) {
        ...
        if (UrlObj['BU'] && UrlObj['BU'] == 'FT') {
            let tIdx = DefaultObj.DisplayArr.indexOf('機型');
    ...
    */
    FreezeField(tPageName) {
        ...
        if (ColumnFixObj[tPageName]) {
            ...
            for (var i = 0; tableDom.eq(i).html(); i++) {
                var LeftWidth = 0;
                var ThLeftWidth = 0;
                for (var j = 0; (ColumnFixObj[tPageName].LeftCount != undefined && j < ColumnFixObj[tPageName].LeftCount)
                    || (ColumnFixObj[tPageName].FixIndex != undefined && j <= Math.max(...ColumnFixObj[tPageName].FixIndex)); j++) {
                    ...
                    if (tableDom.eq(i).find('td').eq(j).css('display') != 'none'
                        && (ColumnFixObj[tPageName].LeftCount != undefined
                            || (ColumnFixObj[tPageName].FixIndex != undefined && ColumnFixObj[tPageName].FixIndex.indexOf(j) > -1))) {
    ...
    MergeTableValue(tPageName) {
        ...
        let MergeInf = {
            BP_Query: {
                CheckXRange: bu == 'RFE' || bu == 'WAF' || bu == 'PKG' ? 2 : bu == 'ATE' || bu == 'YSZA' || bu == 'CRT' || bu == 'CSYC' ? gPageObj.PageNameObj[tPageName].TitleStrArr.length - (((_b = (_a = gPageObj.PageNameObj[tPageName]) === null || _a === void 0 ? void 0 : _a.LastQuery) === null || _b === void 0 ? void 0 : _b.QueryArr[1]) == '月' ? 13 : 5) * 2 - 1 : 0,
                XWayRange: {},
                IgnoreXIdx: [],
            },
            Area_Query: {
        ...
        if ((bu == 'ATE' || bu == 'YSZA' || bu == 'CRT' || bu == 'CSYC') && tPageName == 'BP_Query') {
            for (let i = 3; i < MergeInf[tPageName].CheckXRange; i++) {
                (_c = MergeInf[tPageName].IgnoreXIdx) === null || _c === void 0 ? void 0 : _c.push(i);
            }
        }
...
export class ValueDisplay {
    constructor() {
        this.RuleObj = {
            'FieldName': {
                ...
                'Jan': {
                    KilobitFormat: true,
                    MillionFormat: (tPageName, Value, tFieldName, tRowTitleName) => {
                        let re = true;
                        switch (tPageName) {
                            case 'AP_VS_FCST':
                                let tStr = (tRowTitleName ? tRowTitleName : '').toLocaleLowerCase();
                    ...
                    Digits: (tPageName, Value, tFieldName, tRowTitleName) => {
                        let re = '';
                        switch (tPageName) {
                            case 'AP_VS_FCST':
                                let tStr = (tRowTitleName ? tRowTitleName : '').toLocaleLowerCase();
                    ...
                    TailString: (tPageName, Value, tFieldName, tRowTitleName) => {
                        let re = '';
                        switch (tPageName) {
                            case 'AP_VS_FCST':
                                let tStr = (tRowTitleName ? tRowTitleName : '').toLocaleLowerCase();
    ...
    NeedModifyDisplay(tFieldName, valueStr, tPageName, tRowTitleName) {
        ...
        if (!this.ExRule(tFieldName, tPageName, valueStr, tRowTitleName)) {
            return valueStr;
        }
        var tmpStr = valueStr.toString().replace('%', '');
        //先跑Rule Function
        for (let Key in this.RuleObj) {
            ...
            tmpStr = ((_j = (_h = (_g = this.RuleObj[Key]) === null || _g === void 0 ? void 0 : _g[tmpName]) === null || _h === void 0 ? void 0 : _h.TailString) === null || _j === void 0 ? void 0 : _j.call(_h, tPageName, tmpStr, tFieldName, tRowTitleName)) || tmpStr;
        }
        //再判斷是否需要轉換百萬格式或千分位格式
        for (let Key in this.RuleObj) {
            let tmpName = Key == 'FieldName' ? tFieldName : Key == 'RowTitle' && tRowTitleName ? tRowTitleName : Key == 'PageName' ? tPageName : '';
            ...
            if (((_l = (_k = this.RuleObj[Key]) === null || _k === void 0 ? void 0 : _k[tmpName]) === null || _l === void 0 ? void 0 : _l.MillionFormat) || ((_o = (_m = this.RuleObj[Key]) === null || _m === void 0 ? void 0 : _m[tmpName]) === null || _o === void 0 ? void 0 : _o.KilobitFormat)) {
                ...
                tmpStr = ((_q = (_p = this.RuleObj[Key]) === null || _p === void 0 ? void 0 : _p[tmpName]) === null || _q === void 0 ? void 0 : _q.MillionFormat) === true
                    || (typeof ((_s = (_r = this.RuleObj[Key]) === null || _r === void 0 ? void 0 : _r[tmpName]) === null || _s === void 0 ? void 0 : _s.MillionFormat) === 'function' && ((_u = (_t = this.RuleObj[Key]) === null || _t === void 0 ? void 0 : _t[tmpName]) === null || _u === void 0 ? void 0 : _u.MillionFormat(tPageName, tmpStr, tFieldName, tRowTitleName)) === true)
                ...
                tmpStr = ((_w = (_v = this.RuleObj[Key]) === null || _v === void 0 ? void 0 : _v[tmpName]) === null || _w === void 0 ? void 0 : _w.KilobitFormat) === true
                    || (typeof ((_y = (_x = this.RuleObj[Key]) === null || _x === void 0 ? void 0 : _x[tmpName]) === null || _y === void 0 ? void 0 : _y.KilobitFormat) === 'function' && ((_0 = (_z = this.RuleObj[Key]) === null || _z === void 0 ? void 0 : _z[tmpName]) === null || _0 === void 0 ? void 0 : _0.KilobitFormat(tPageName, tmpStr, tFieldName, tRowTitleName)) === true)
        ...
        if (this.FieldIsOnclick(tPageName, FieldName, RowTitle)) {
            ...
            for (let i = 0; i < NeedClickObj[tPageName][FieldName].ValueQuery.length; i++) {
                ...
                if (typeof NeedClickObj[tPageName][FieldName].ValueQuery[i] == 'number') {
                    ...
                    let tNumber = tArr[0].replace('[', '').replace(']', '');
                    if (!isNaN(Number(tNumber))) {
                        HtmlStr += tNumber;
                    }
                }
                else {
    ...
    isConformRule(tPageName, Others, CellIdx, RowTitle) {
        ...
        for (let x in Others) {
            if (x != 'Score') {
                ...
                let tCellTitleArr = tmpCellValue.indexOf('/') > -1 ? tmpCellValue.split('/') : [];
                //先判斷RowTitle
        ...
        for (let i = 0; i < tData.length; i++) {
            ...
            if (ColorRuleArr[tPageName] && ColorRuleArr[tPageName][i] && ColorRuleArr[tPageName][i][0]) {
                for (let tRule in ColorRuleArr[tPageName][i][0]) {
                    let tIdxArr = tRule.match(regexp) || [];
                    for (let m = 0; m < tLineData.length; m++) {
                        ...
                        if (isConform) {
                            ...
                            if (eval(tmRule)) {
                                let tNode = {
                                    Color: ColorRuleArr[tPageName][i][0][tRule].Color,
                                    BackgroundColor: ColorRuleArr[tPageName][i][0][tRule].BackgroundColor,
                ...
                for (let tRule in ColorRuleArr[tPageName][RowTitle[i]][0]) {
                    ...
                    for (let m = 0; m < tLineData.length; m++) {
                        ...
                        if (isConform) {
                            ...
                            if (eval(tmRule)) {
                                let tNode = {
                                    Color: ColorRuleArr[tPageName][RowTitle[i]][0][tRule].Color,
                                    BackgroundColor: ColorRuleArr[tPageName][RowTitle[i]][0][tRule].BackgroundColor,
                ...
                if (ColorRuleArr[tPageName][CellIdx][1] && (!isNaN(Number(CellIdx)) || tCellIdx > -1)) {
                    ...
                    for (let tRule in ColorRuleArr[tPageName][CellIdx][1]) {
                        ...
                        if (isConform) {
                            ...
                            if (eval(tmRule)) {
                                let tNode = {
                                    Color: ColorRuleArr[tPageName][CellIdx][1][tRule].Color,
                                    BackgroundColor: ColorRuleArr[tPageName][CellIdx][1][tRule].BackgroundColor,
            ...
            if (this.UrlInfObj[tPageName] && this.UrlInfObj[tPageName][tFieldName] && this.UrlInfObj[tPageName][tFieldName].RowTitleEx && this.UrlInfObj[tPageName][tFieldName].RowTitleEx[tRowTitle] != null) {
                ...
                for (let KeyName in this.UrlInfObj[tPageName][tFieldName].RowTitleEx[tRowTitle].key) {
                    ...
                    if (this.UrlInfObj[tPageName][tFieldName].RowTitleEx[tRowTitle].key[KeyName].ValueForFieldName != null) {
                        ...
                        tValueStr = $('input[name="' + this.UrlInfObj[tPageName][tFieldName].RowTitleEx[tRowTitle].key[KeyName].ValueByName + '"]:checked').val();
                    }
                ...
                for (let KeyName in this.UrlInfObj[tPageName][tFieldName].key) {
                    ...
                    if (this.UrlInfObj[tPageName][tFieldName].key[KeyName].ValueForFieldName != null) {
                        ...
                        tValueStr = $('input[name="' + this.UrlInfObj[tPageName][tFieldName].key[KeyName].ValueByName + '"]:checked').val();
                    }
                    tValueStr = this.TransFromValue(tPageName, tFieldName, KeyName, tValueStr);
                    if (!first) {
                        reUrlStr += '&';
